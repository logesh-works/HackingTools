...
class autophisher(HackingTools):
...
class AdvPhishing(HackingTools):
    TITLE = "AdvPhishing"
...
class WifiPhisher(HackingTools):
    TITLE = "WifiPhisher"
