...
echo -e "${BLUE}                                    https://github.com/logesh-works/HackingTools ${NC}"
...
install_dir="/usr/share/HackingTools"
bin_dir="/usr/bin"
...
if [[ $choice =~ ^[1-2]+$ ]]; then
    ...
    if curl -s -m 10 https://www.google.com > /dev/null || curl -s -m 10 https://www.github.com > /dev/null; then
        ...
        if sudo git clone https://github.com/logesh-works/HackingTools.git $install_dir; then
...
#            echo '#!/bin/bash' > HackingTools.sh
    ...
    if [ -d $install_dir ]; then
        ...
        echo -e  "${ORANGE}[+]+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++[+]"
        echo     "[+]                                                             [+]"
        echo -e  "${ORANGE}[+]     ✔✔✔ Now Just Type In Terminal (HackingTools) ✔✔✔      [+]"
        echo     "[+]                                                             [+]"
        echo -e  "${ORANGE}[+]+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++[+]"
    else
